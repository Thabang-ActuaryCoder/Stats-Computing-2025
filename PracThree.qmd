...
# subtitle: "Day Five : Projects in R"
...
print("Routes with multiple airlines:")
multi_airline_routes %>% head()
...
print("Average delays per airline on shared routes:")
route_delays |> arrange(origin, dest) |> head()
```
...
route_comparison |> arrange(desc(delay_diff)) |> head()
```
...
print("Route with largest performance gap:")
max_diff_route
```
